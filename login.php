...
<body>
    <div class="judul-hlm">
        ...
        <div class="ket-hlm"><a href="#">Daftar disini</a></div>
    </div>
    ...
    <form action="action_page.php" style="border:none #ccc">
        <div class="container">
          ...
          <p style="font-size: small;">Anda telah setuju dengan ketentuan <a href="#" style="color:dodgerblue">Terms & Privacy</a>.</p>
